...
> **Note**: To access these emotes, ensure that you have **7TV** installed and set up for your Twitch channel. The emotes can be added to your chat for any viewer to use during your streams. </br>
